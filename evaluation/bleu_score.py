...
if __name__ == '__main__':
    ...
    MTefiles = ["Mahabharatha-Adiparva-Section22-en-MT.txt", "Mahabharatha-Adiparva-Section23-en-MT.txt", "Mahabharatha-Adiparva-Section24-en-MT.txt", 
    ...
    # Calculating BLEU scores for the machine translated files (IndicTrans)
